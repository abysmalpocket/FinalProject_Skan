...
function Search() {
  ...
  const limit = useSelector((state) => state.user.companyLimit);
  ...
  const handleChangeInn = (e) => {
    ...
    setIsValid((prevState) => ({
      ...prevState,
      innValid: checkInn(e.target.value),
    }));
  };
  ...
  const handleChangeQuantity = (e) => {
    ...
    setIsValid((prevState) => ({
      ...prevState,
      quantityValid: checkLimit(e.target.value),
    }));
  };
  ...
  useEffect(() => {}, [token, limit, publication]);
  return (
