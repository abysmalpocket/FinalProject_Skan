...
const Header = () => {
  ...
  useEffect(() => {}, [authorization, showLoader, usedCompanyCount, companyLimit]);
        ...
        <div className="company__main-info">
          <div className={ showLoader ? 'company_info_center' :'company__info'}>
            {showLoader  ? (
              ...
              <div>
                <p className="company__info-text">Использовано компаний: {usedCompanyCount}</p>
                <p className="company__info-text">Лимит по компаниям: {companyLimit}</p>
              </div>
            )}
          </div>
          <div className="user__info">
            <div className="user__info-panel">
              ...
              <button onClick={(e) => handleClickLogout(e)} className="header__exit-btn">Выйти</button>
            </div>
            <img
